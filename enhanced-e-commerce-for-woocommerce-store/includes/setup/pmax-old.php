                ...
                <div class="dashtablewrp campaign_pmax_list" id="campaign_pmax_list">
                    ...
                    <div class="syncprofooter">
                        ...
                        <div class="syncpropagination">
                            ...
                            <ul>
                                <li class="prevli"><button data-token="" class="paginitem pgprevbtn" disabled><?php esc_html_e("Prev", "enhanced-e-commerce-for-woocommerce-store"); ?></button>
                                </li>
                                <li class="nextli"><button data-token="" data-token="" class="paginitem pgnextbtn"><?php esc_html_e("Next", "enhanced-e-commerce-for-woocommerce-store"); ?></button>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <b style="color:#2196F3; cursor:pointer" data-bs-toggle="tooltip" data-bs-placement="left" title="<?php echo esc_attr($pmaxStatus->data->request_reason) ?>">
