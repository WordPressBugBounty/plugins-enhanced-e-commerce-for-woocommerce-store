...
<div class="container-fluid pt-4 px-50">
    ...
    <div class="row row-x-0 align-items-center">
        <div class="m-0 p-0 <?php echo isset($result[0]['status']) && $result[0]['status'] === 'Draft' ? 'col-12' : 'col-8' ?>">
        ...
        <div class="m-0 p-0 filteredProductSynDiv <?php echo isset($result[0]['status']) && $result[0]['status'] === 'Draft' ? 'col-12' : 'col-4 d-flex justify-content-end' ?>">
            <div class="<?php echo isset($result[0]['status']) && $result[0]['status'] === 'Draft' ? 'alert alert-danger' : '' ?> m-0 d-flex align-items-center justify-content-end fs-6">
                <?php if (isset($result[0]['status']) && $result[0]['status'] === 'Draft') : ?>
                ...
                <form id="productSync" action="" class="d-flex justify-content-center flex-column" style="min-height:50vh">
                    ...
                    <div style="overflow:auto;" class="pt-2">
                        <div style="" class="allBtn">
                            ...
                            <button class="btn btn-soft-primary btn-success m-1" type="button" id="syncBtn" onclick="snyNowAutomatic()" style="display:none;height:38px;">Allow us to complete this automatically</button>
                        </div>
                    </div>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery(document).on('click', '.filteredProductSyn', function(e) {
            ...
            if (!jQuery.isEmptyObject(productArray) || !jQuery.isEmptyObject(exclude) || (thisVal ==
                ...
                if (totProduct > 1000 || (totProduct + syncProductCount) > 1000) {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (response.status == "success") {
                    var message = "Your products are being synced. Data will reflect in the dashboards within 30 minutes, and you can check product status in the feeds.";
                    ...
                    setTimeout(function() {
                        ...
                        var anchorTag = '<a href="' + url + '" class="btn btn-secondary fs-20 fw-normal">Close</a>'
