...
<div class="container-fluid pt-4 px-50">
            ...
            <div class="m-0 p-0 col-12">
                <div class="conv-heading-box d-flex align-items-center">
                    ...
                    <div class="conv-link-blue d-flex align-items-center ms-2">
                        <span style="cursor: pointer" class="material-symbols-outlined fs-14 me-1"
                            onclick="editFeed(<?php echo filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT); ?>)">edit</span>
                        <label class="fs-14 text"
    ...
    <div class="row row-x-0 align-items-center">
        ...
        ?>
        <div
            class="woow-292 m-0 p-0 <?php echo esc_attr( $class_column ); ?>">
            <div class="conv-heading-box">
                <span>
                    ...
                    <label class="col-form-label fs-14 fw-400 pt-2">
                        ...
                        <img class="<?php echo esc_attr(strtolower(str_replace(' ', '', $result[0]['ms_status']))) ?>-status"
                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/ms_channel_logo.svg'); ?>"
                            title="<?php echo "MMC Id - " . esc_attr($microsoft_merchant_center_id) ?>" />
                        <?php }
                        }
                        ?>
                    </label>
        ...
        <div class="m-0 p-0 filteredProductSynDiv <?php echo esc_attr($class_1);  ?>">
            <div class="<?php echo esc_attr($class_2); ?> m-0 d-flex align-items-center justify-content-end fs-6">
                <?php if ( $class_2 != '') : ?>
                    <span>Your feed is in draft mode. Sync your products with
                    <?php echo esc_html(implode(", ", $convfeedchnames)) ?> by clicking here.</span>
                <?php endif; ?>
                <?php
                    ...
                    <th scope="col" class="text-center sorting_disabled">
                        <select class="selectStatus" id="selectStatus">
                            ...
                            <?php if (in_array('2', $channel_id)) { ?><option value="2"
                                ...
                                Status</option> <?php } ?>
                            <?php if (in_array('4', $channel_id)) { ?><option value="4"
                                <?php echo isset($channel_id[0]) && $channel_id[0] == 4 ? 'selected' : '' ?>>MMC
                                Status</option> <?php } ?>
                        </select>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-check-custom">
                            <input class="form-check-input check-height fs-14 errorChannel" type="checkbox"
                                value="<?php echo esc_attr($microsoft_merchant_center_id); ?>" id="mmc_id" name="mmc_id"
                                <?php echo $microsoft_merchant_center_id !== '' ? "checked" : 'disabled' ?>>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="wrapper p-20 pt-0" style="overflow:auto">
                <form id="productSync" action="" class="d-flex justify-content-center flex-column"
                    ...
                    <div style="overflow:auto;" class="pt-2">
                        <div style="" class="allBtn">
                            <button class="btn btn-soft-primary me-1 ms-1" type="button" id="prevBtn"
                                onclick="nextPrev(-1)" style="min-width:130px; height:38px;">Previous</button>
                            <button class="btn btn-soft-secondary m-1" type="button" id="nextBtn" onclick="nextPrev(1)"
                                style="height:38px;">Next</button>
                            <button class="btn btn-soft-primary btn-success m-1" type="button" id="syncBtn"
                                onclick="snyNowAutomatic()" style="display:none;height:38px;">Allow us to complete this
    ...
    <div class="modal-dialog modal-dialog-centered max-w-600">
        <div class="modal-content shadow-lg border-0">
            ...
            <div class="modal-footer px-4 pb-4 mb-1 modalFooterSuccess">
                <button class="btn btn-secondary fs-20 fw-normal text-white dismissModal"
                ...
                success: function(response) { console.log(response); //wow
                    ...
                    if (response != "Product does not exists" && response !=
                        ...
                        jQuery.each(response, function(key, value) {
                            ...
                            console.log('wow2');console.log(value); console.log(value.microsoftStatus+'=pid='+prodID[3]); //wow2
                        });
    ...
    jQuery(document).on('click', '.filteredProductSyn', function(e) {
        ...
        jQuery.ajax({
            ...
            success: function (total_product_feed) {
                ...
                console.log('your current limit='+total_product_feed); console.log('you max limit=100');
            ...
            success: function(response) {
                ...
                if (response != "Product does not exists" && response != "Product not synced") {
                    ...
                    jQuery.each(response, function(key, value) {
                        ...
                        console.log('wow1');console.log(value); //wow1
                    });
