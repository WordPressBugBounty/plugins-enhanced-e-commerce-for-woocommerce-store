                    ...
                    <div class="p-3 convcard d-flex justify-content-between-no flex-column conv-pixel-list-item border <?php echo esc_attr($conv_gtm_not_connected); ?>">
                        ...
                        <div class="pt-3 pb-3 pixel-desc">
                            <div class="d-flex align-items-start flex-column">
                                ...
                                <?php } else { ?>
                                    <div class="d-flex align-items-center pb-1 mb-1 border-bottom"><span class="material-symbols-outlined text-error me-1 fs-16 ps-1">cancel</span><span>Linkedin Insight ID: Not connected</span></div>
                                <?php } ?>



                                <div class="alert alert-danger d-flex align-items-center p-1 mt-1 mb-0"><span class="material-symbols-outlined text-error me-1 fs-16">cancel</span>LinkedIn Conversion API (Server Side)&nbsp;
