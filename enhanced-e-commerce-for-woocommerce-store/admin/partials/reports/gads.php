    ...
    <div style="display:flex; align-items:center; gap:16px;">
        ...
        <div>
            <div style="font-size:16px; font-weight:700; color:#1e293b; margin-bottom:4px; line-height:1.3;">
                <?php esc_html_e('Google Ads Reports — Available in Paid Plan', 'enhanced-e-commerce-for-woocommerce-store'); ?>
            </div>
            <div style="font-size:13px; color:#5f6368; line-height:1.5;">
                <?php esc_html_e('Unlock Campaign Performance, ROAS, Ad Spend, Conversions and more.', 'enhanced-e-commerce-for-woocommerce-store'); ?>
            </div>
        </div>
    </div>
...
<div style="max-width: 900px; margin: 0 auto;">
    <div style="border-radius: 10px; overflow: hidden; box-shadow: 0 2px 16px rgba(0,0,0,0.12);">
        <?php echo wp_kses(
            enhancad_get_plugin_image('/admin/images/web-reports-gads.webp', '', '', 'max-width:100%; height:auto; display:block;'),
            array(
                'img' => array(
                    'src'   => true,
                    'alt'   => true,
