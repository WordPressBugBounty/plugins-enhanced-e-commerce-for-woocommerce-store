                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="" style="justify-content: center">
                                    ...
                                    <a href="<?php echo esc_url_raw('admin.php?page=conversios-google-shopping-feed&subpage=tiktokBusinessSettings'); ?>">Connect
                ...
                <div class="modal-body ps-4 pt-0">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-7 feed_name">
                            <input type="text" class="form-control-sm fs-14 " <?php echo ($plan_id === 1) ? 'readonly="readonly"' : ''; ?> name="autoSyncIntvl" id="autoSyncIntvl" size="3" min="1" onkeypress="return ( event.charCode === 8 || event.charCode === 0 || event.charCode === 13 || event.charCode === 96) ? null : event.charCode >= 48 && event.charCode <= 57" oninput="removeZero();" value="25">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check form-check-custom">
                            <input class="form-check-input check-height fs-14 errorChannel" type="checkbox" value="" id="fb_id" name="fb_id" checked>
                            <label for="" class="col-form-label fs-14 pt-0 text-dark fw-500">
                                <?php esc_html_e("Facebook Catalog Id :", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </label>
