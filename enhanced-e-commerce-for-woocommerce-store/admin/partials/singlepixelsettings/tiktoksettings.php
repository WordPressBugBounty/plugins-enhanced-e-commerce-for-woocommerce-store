...
<div class="conv-card p-4 rounded conv-shadow-sm">
    ...
    <div class="d-flex align-items-center mb-3">
        <?php echo wp_kses(
            enhancad_get_plugin_image('/admin/images/logos/conv_tiktok_logo.png', '', 'align-self-center conv-channel-logo'),
            array(
                'img' => array(
                    'src' => true,
                    'alt' => true,
        ...
        <h4 class="conv-card-title ms-2">TikTok Pixel</h4>
    </div>
    ...
    <form id="pixelsetings_form" class="convpixsetting-inner-box">
        <div>
            ...
            <div id="tiktok_box" class="py-1">
                <div class="row pt-2">
                    <div class="col-6">
                        <label class="conv-field-label d-flex align-items-center"><?php esc_html_e("TikTok Pixel ID:", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </label>
                        <input type="text" name="tiKtok_ads_pixel_id" id="tiKtok_ads_pixel_id" class="form-control valtoshow_inpopup_this" value="<?php echo esc_attr($tiKtok_ads_pixel_id); ?>">
                        <a href="https://www.conversios.io/blog/how-to-find-your-tiktok-pixel-id-and-conversion-api-token/?utm_source=woo_aiofree_plugin&utm_medium=otherpixelsetting&utm_campaign=woo_aiofree_plugin" target="_blank" style="font-size: 12px; color: #0073aa; font-weight: 500; text-decoration: none; display:inline-block; margin-top:4px;">How to Find TikTok Pixel ID &rarr;</a>
                    </div>
                </div>
            </div>
            <!-- Tiktok Pixel End-->
        ...
        <div class="p-4 mt-3" style="background: linear-gradient(135deg, #e8f0fe 0%, #d4e4fc 100%); border-radius: 8px;">
            <div class="row align-items-center">
                ...
                <div class="col-md-9 col-sm-8">
                    <h5 class="mb-3" style="font-size: 15px; font-weight: 700; color: #202124; margin-top: 0;"><?php esc_html_e("Get the benefit of TikTok Events API:", "enhanced-e-commerce-for-woocommerce-store"); ?></h5>
                    <div class="row">
                        <div class="col-md-6 col-12">
                            ...
                            <div class="conv-pro-feature-item mb-2" style="display: flex; align-items: center; padding: 0;">
                                <svg class="conv-pro-check" viewBox="0 0 24 24" style="flex-shrink: 0; width: 18px; height: 18px; margin-right: 8px;"><circle cx="12" cy="12" r="12" fill="#e6f7ee"/><path d="M7 12.5l3 3 7-7" stroke="#2ec471" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                <span style="font-size: 14px; color: #4a5568; font-weight: 500; line-height: 1.4;"><?php esc_html_e("Accurate server-side tracking (TikTok Events API)", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="conv-pro-feature-item mb-2" style="display: flex; align-items: center; padding: 0;">
                                <svg class="conv-pro-check" viewBox="0 0 24 24" style="flex-shrink: 0; width: 18px; height: 18px; margin-right: 8px;"><circle cx="12" cy="12" r="12" fill="#e6f7ee"/><path d="M7 12.5l3 3 7-7" stroke="#2ec471" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                <span style="font-size: 14px; color: #4a5568; font-weight: 500; line-height: 1.4;"><?php esc_html_e("Achieve up to 93% TikTok Match Rate", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                            </div>
                            <div class="conv-pro-feature-item mb-2" style="display: flex; align-items: center; padding: 0;">
                                <svg class="conv-pro-check" viewBox="0 0 24 24" style="flex-shrink: 0; width: 18px; height: 18px; margin-right: 8px;"><circle cx="12" cy="12" r="12" fill="#e6f7ee"/><path d="M7 12.5l3 3 7-7" stroke="#2ec471" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
